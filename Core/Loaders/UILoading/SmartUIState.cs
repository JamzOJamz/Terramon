...
public abstract class SmartUIState : UIState
{
    ...
    internal void AddElement(UIElement element, int x, float xPercent, int y, float yPercent, int width,
        float widthPercent, int height, float heightPercent)
    {
    ...
    /// <summary>
    ///     A Safe wrapper around XButton1MouseUp that allows both an override and the OnXButton1MouseUp event to be used
    ///     together
    /// </summary>
    ...
    /// <summary>
    ///     A Safe wrapper around XButton1MouseDown that allows both an override and the OnXButton1MouseDown event to be used
    ///     together
    /// </summary>
    /// <param name="evt">The mouse event that occured to fire this listener</param>
    ...
    /// <summary>
    ///     A Safe wrapper around XButton1DoubleClick that allows both an override and the OnXButton1DoubleClick event to be
    ///     used together
    /// </summary>
    /// <param name="evt">The mouse event that occured to fire this listener</param>
    ...
    /// <summary>
    ///     A Safe wrapper around XButton2MouseUp that allows both an override and the OnXButton2MouseUp event to be used
    ///     together
    /// </summary>
    /// <param name="evt">The mouse event that occured to fire this listener</param>
    ...
    /// <summary>
    ///     A Safe wrapper around XButton2MouseDown that allows both an override and the OnXButton2MouseDown event to be used
    ///     together
    /// </summary>
    /// <param name="evt">The mouse event that occured to fire this listener</param>
    ...
    /// <summary>
    ///     A Safe wrapper around XButton2DoubleClick that allows both an override and the OnXButton2DoubleClick event to be
    ///     used together
    /// </summary>
    /// <param name="evt">The mouse event that occured to fire this listener</param>
    ...
    /// <summary>
    ///     A Safe wrapper around RightMouseDown that allows both an override and the OnRightMouseDown event to be used
    ///     together
    /// </summary>
    /// <param name="evt">The mouse event that occured to fire this listener</param>
    ...
    /// <summary>
    ///     A Safe wrapper around RightDoubleClick that allows both an override and the OnRightDoubleClick event to be used
    ///     together
    /// </summary>
    /// <param name="evt">The mouse event that occured to fire this listener</param>
    ...
    /// <summary>
    ///     A Safe wrapper around MiddleMouseDown that allows both an override and the OnMiddleMouseDown event to be used
    ///     together
    /// </summary>
    /// <param name="evt">The mouse event that occured to fire this listener</param>
    ...
    /// <summary>
    ///     A Safe wrapper around MiddleDoubleClick that allows both an override and the OnMiddleDoubleClick event to be used
    ///     together
    /// </summary>
    /// <param name="evt">The mouse event that occured to fire this listener</param>
