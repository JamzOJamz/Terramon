...
namespace Terramon.Content.Dusts
{
    public class GlowDustTemplate : ModDust
    {
        ...
        public override void OnSpawn(Dust dust)
        {
            ...
            dust.color.G = 0;
            dust.color.B = 255;
            dust.shader = new ArmorShaderData(new Ref<Effect>(Terramon.Instance.Assets.Request<Effect>("Effects/GlowingDust", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value), "GlowingDustPass");
        }
